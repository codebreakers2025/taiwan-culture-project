          ...
          <Card className="p-3 confirmation-card">
            <Card.Body>
              ...
              <div className="mt-4 text-center">
                <Button variant="secondary" className="me-2" onClick={() => navigate("/activity-list/booking1")}>返回行程資訊</Button>
                <Button variant="primary" className="px-4" onClick={() => navigate("/activity-list/booking3")}>去結帳</Button>
              </div>
            </Card.Body>
          </Card>
        </Col>
